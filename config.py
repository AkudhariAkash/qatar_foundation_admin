...
def _build_database_uri():
    ...
    if os.getenv("RENDER") and not (db_host and db_user and db_password):
        raise RuntimeError(
            "Set DATABASE_URL or DB_HOST/DB_USER/DB_PASSWORD/DB_PORT/DB_NAME in Render Environment Variables."
        )
